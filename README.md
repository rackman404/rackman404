...
| ![Github Actions](https://img.shields.io/badge/-Github_Actions-blue?style=flat-square&logo=githubactions&logoColor=white) | ![Docker](https://img.shields.io/badge/-Docker-blue?style=flat-square&logo=Docker&logoColor=white)<br> |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |


### Testing

| ![JUnit](https://img.shields.io/badge/-JUnit_(Java)-blue?style=flat-square&logo=junit5&logoColor=white) | ![NUnit](https://img.shields.io/badge/-NUnit_(C_Sharp)-blue?style=flat-square&logo=Nunit&logoColor=white)<br> | ![Unittest](https://img.shields.io/badge/-Unittest_(Python)-blue?style=flat-square&logo=unittest&logoColor=white)<br> |
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
...
- Current stable public build can be played here: (LINK)
	- Note that WebGL build that can be played in browser differs slightly from the windows build (forced to use fallback shaders and other compromises due to WebGL limits)
- Tech Stack: 
	- Game Engine: Unity
...
- Unfinished and abandoned but placed in this category cause im quite proud of my dynamic terrain generator system
- Tech Stack: Unity
...
- COE628 Labs
	...
	- Will make this repo public after i graduate probably
- COE428 Labs
	- General Algorithms and Data Structures Lab work done for the course
	- Will make this repo public after i graduate probably
...
(2025-Current) [Tauri based Avionics Groundstation GUI](https://github.com/Ryerson-Rocketry/Avionics-Tauri-Groundstation-SRAD-GUI)
	...
	- Displays telemetry in the following format: 3D map with rocket position/flight path and trackball, 2D map, textual displays, graphs
	- Used during IREC 2026
